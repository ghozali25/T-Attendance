...
SELECT 
    ...
    DATE_SUB(DATE_ADD('2026-01-05', INTERVAL seq DAY + INTERVAL 8 HOUR), INTERVAL 7 HOUR),
    DATE_SUB(DATE_ADD('2026-01-05', INTERVAL seq DAY + INTERVAL 17 HOUR), INTERVAL 7 HOUR),
...
SELECT 
    ...
    DATE_SUB(DATE_ADD('2026-02-02', INTERVAL seq DAY + INTERVAL 8 HOUR), INTERVAL 7 HOUR),
    DATE_SUB(DATE_ADD('2026-02-02', INTERVAL seq DAY + INTERVAL 17 HOUR), INTERVAL 7 HOUR),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-02'
...
SELECT 
    ...
    DATE_SUB(DATE_ADD('2026-03-02', INTERVAL seq DAY + INTERVAL 8 HOUR), INTERVAL 7 HOUR),
    DATE_SUB(DATE_ADD('2026-03-02', INTERVAL seq DAY + INTERVAL 17 HOUR), INTERVAL 7 HOUR),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-03'
...
SELECT 
    ...
    DATE_SUB(DATE_ADD('2026-04-01', INTERVAL seq DAY + INTERVAL 8 HOUR), INTERVAL 7 HOUR),
    DATE_SUB(DATE_ADD('2026-04-01', INTERVAL seq DAY + INTERVAL 17 HOUR), INTERVAL 7 HOUR),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-04'
