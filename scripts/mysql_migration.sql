...
SELECT 
    ...
    TIMESTAMP(CONCAT(DATE_ADD('2026-01-05', INTERVAL seq DAY), ' 01:00:00')),
    TIMESTAMP(CONCAT(DATE_ADD('2026-01-05', INTERVAL seq DAY), ' 10:00:00')),
...
SELECT 
    ...
    TIMESTAMP(CONCAT(DATE_ADD('2026-02-02', INTERVAL seq DAY), ' 01:00:00')),
    TIMESTAMP(CONCAT(DATE_ADD('2026-02-02', INTERVAL seq DAY), ' 10:00:00')),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-02'
...
SELECT 
    ...
    TIMESTAMP(CONCAT(DATE_ADD('2026-03-02', INTERVAL seq DAY), ' 01:00:00')),
    TIMESTAMP(CONCAT(DATE_ADD('2026-03-02', INTERVAL seq DAY), ' 10:00:00')),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-03'
...
SELECT 
    ...
    TIMESTAMP(CONCAT(DATE_ADD('2026-04-01', INTERVAL seq DAY), ' 01:00:00')),
    TIMESTAMP(CONCAT(DATE_ADD('2026-04-01', INTERVAL seq DAY), ' 10:00:00')),
    -6.2088, 106.8456, -6.2088, 106.8456,
    CASE WHEN RAND() > 0.8 THEN 'late' ELSE 'present' END,
    8.0,
    '2026-04'
